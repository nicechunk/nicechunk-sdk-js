# nicechunk-sdk-js License Status

nicechunk-sdk-js does not currently publish a public open-source license file.
...
Before a public open-source release, the owner should choose whether nicechunk-sdk-js uses the same license as the wider NiceChunk repository set or needs repository-specific terms.
